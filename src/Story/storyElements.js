const storyElements = [
  {
    id: 'beginning',
    text: "In a world where the boundaries of imagination merged with the vast expanse of the cosmos, a young dreamer was born. From the tender age of eight, the universe beckoned to their soul, filling their days with wonder and their nights with celestial dreams. Their spirit soared amidst the cosmic ballet, as the mysteries of distant galaxies whispered secrets in their ears.\n\nLittle did this child know, they were destined for a life beyond the ordinary. Their birth was not a mere chance occurrence but the result of a divine plan. A powerful deity, yearning for a connection with the mortal realm, had chosen to incarnate as an earth woman, imbuing her with celestial magic. This mystical union gave rise to a child who possessed extraordinary abilities beyond their wildest imagination.\n\nAs the child grew, their connection to the cosmos deepened, although they remained oblivious to their true nature. The deity's powers lay dormant within them, waiting for the day when destiny would awaken their dormant gifts.",
    background: "",
    choices: [
...
export default storyElements;
  ...
  //     background: "",
  //     choices: [
  //       { id: 'join_treasure_hunt', text: "Join the treasure hunt", nextElement: 'start_treasure_hunt' },
  //       // Or the player can visit the market to prepare.
  //       { id: 'visit_market', text: "Visit the market and prepare for the journey", nextElement: 'visit_market' },
  //     ],
  //   },
  //   {
  //     id: 'start_treasure_hunt',
  ...
  //     background: "",
  //     choices: [
  //       // The player can choose to continue following the map.
  //       { id: 'follow_map', text: "Continue to follow the map", nextElement: 'follow_map' },
  //       // Or the player can seek assistance from the locals.
  //       { id: 'seek_assistance', text: "Seek assistance from the locals", nextElement: 'seek_assistance' },
  //     ],
  //   },
  //   {
  //     id: 'visit_market',
  ...
  //     background: "",
  //     choices: [
  //       // The player can choose to seek out the secret society.
  //       { id: 'seek_secret_society', text: "Seek out the secret society", nextElement: 'seek_secret_society' },
  //       // Or the player can ignore the whispers and follow the map.
  //       { id: 'ignore_whispers', text: "Ignore the whispers and follow the map", nextElement: 'start_treasure_hunt' },
  //     ],
  //   },
  //   {
  //     id: 4,
