const storyElements = [
  {
    id: 'beginning',
    text: "In the beginning, there was nothing but the endless void of the cosmos, a vast expanse filled with silent echoes of what might be. Uncharted constellations stretched into the far reaches, their stories yet untold, their beauty untouched. The universe was a symphony of silence, a tableau of dormant potential, waiting for the maestro to command the first note.\n\nAnd then, a spark.\n\nWith a surge of energy that could only be divine, light exploded into existence, illuminating the corners of the universe and igniting life within the cosmic womb. The cosmos, which had been still, was now in motion. Stars ignited in brilliant supernovas, galaxies spiraled into existence, and the universe began its eternal dance.\n\nAmidst this glorious spectacle of cosmic creation, you felt yourself being pulled, drawn towards an entity that was not yet formed. The pull was irresistible, and you soared through the kaleidoscope of cosmic light, descending at unfathomable speed, until, with a sudden rush, you found yourself within a new form - your body.\n\nWelcome, Traveler, to your existence.",
    background: "",
    choices: [
  ...
  },
  {
    ...
    background: "https://media.discordapp.net/attachments/1067430982522781707/1109286968090693733/brownsugar_inside_apartmetlooking_at_exit_doorgame_doorbeginnin_71ed1cc5-1ee3-4aa4-8eef-1e0b7cee9d67.png?width=464&height=464",
    choices: [
