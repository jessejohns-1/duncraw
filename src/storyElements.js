const storyElements = [
  {
    id: 0,
    text: "Welcome to the start of your journey. Beyond these doors awaits a story yet to be unraveled. Are you ready to perpetuate the motion and spark the magic that awaits?",
    background: "https://media.discordapp.net/attachments/1067430982522781707/1108971343392804874/brownsugar_doorbeginninggrafiticowboybeebopcitywebsitestart_pag_ef4f5dc9-2abb-41d3-b1ef-14ea87ba76fc.png?width=501&height=501",
    choices: [
      { id: 1, text: "Enter the doors", nextElement: 1 },
      { id: 2, text: "Wait a moment", nextElement: 0 },
    ],
  },
  {
    id: 1,
    ...
    background: "https://media.discordapp.net/attachments/1067430982522781707/1108969534519513148/brownsugar_cityskylinedaftpunkcowboy_beebop_startdewgrungecityb_7e861026-df61-4088-ad58-bab42628f79e.png?width=501&height=501",
    choices: [
      { id: 3, text: "Join the treasure hunt", nextElement: 2 },
      { id: 4, text: "Visit the market and prepare for the journey", nextElement: 3 },
    ],
  },
